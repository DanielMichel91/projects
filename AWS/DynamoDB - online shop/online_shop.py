...
# Initialize Dash app with Bootstrap stylesheets
app = dash.Dash(external_stylesheets=[dbc.themes.BOOTSTRAP])

# Create an area plot for the 'plant' product
fig = px.area(plant_df, x="orderID", y="quantity", color_discrete_sequence=["#ff008b"],
              labels={"orderID": "Bestelldatum", "quantity": "Bestellmenge"})
...
app.layout = dbc.Container([
    ...
    html.Div([html.H6("Bestellinformationen im Format <firstname>,<lastname>,<country>,<product>,<quantity>")]),
...
# Callbacks to update the card components
@app.callback(
...
# Example order input: example@muster.com, Max, Muster, Germany, shoes, 16